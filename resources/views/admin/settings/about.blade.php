                    ...
                    <div class="x_content">
                        ...
                        <form action="{{ route('admin.about_update') }}" method="POST" id="demo-form2"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="description_az" name="description_az"
                                        class="form-control">{{ old('description_az', $aboutSetting->description['az'] ?? '') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="description_en" name="description_en"
                                        class="form-control">{{ old('description_en', $aboutSetting->description['en'] ?? '') }}</textarea>
                                </div>
                            </div>
